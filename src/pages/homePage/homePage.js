...
const MainPage = () => {
  ...
  return (
    <Container sx={{ alignContent: 'center', alignItems: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column', padding: '2em 0', maxWidth: '100%' }}>
      <Box sx={{ backgroundColor: '#D2042D', padding: '3em', borderRadius: '30px' }}>
      ...
      <Grid container spacing={3} sx={{ marginTop: '2em' }} >
        ...
        <Grid item xs={12} md={9} sx={{justifyContent: 'center', alignItems: 'center', display: 'flex', flexDirection: 'column'}}>
